...
class CreateRateTable < ActiveRecord::Migration[5.0]
  def change
    ...
    change_column :rating_rates, :author_type,    :string, limit: 50
    change_column :rating_rates, :resource_type,  :string, limit: 50
    change_column :rating_rates, :scopeable_type, :string, limit: 50
